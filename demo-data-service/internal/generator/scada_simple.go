...
func NewSCADAGenerator() *SCADAGenerator {
	return &SCADAGenerator{
		seriesConfig: map[int]SeriesConfig{
			// Use original 1-12 mapping for simplicity
			1: {Name: "Main Canal Flow Rate", Unit: "CFS", BaseValue: 1000, MinValue: 800, MaxValue: 1200, Pattern: PatternDaily},
			2: {Name: "Don Pedro Reservoir Level", Unit: "feet", BaseValue: 800, MinValue: 780, MaxValue: 820, Pattern: PatternSeasonal},
			3: {Name: "Pump Station 3 Pressure", Unit: "PSI", BaseValue: 50, MinValue: 40, MaxValue: 60, Pattern: PatternOperational},
			4: {Name: "Main Canal Temperature", Unit: "°F", BaseValue: 65, MinValue: 50, MaxValue: 85, Pattern: PatternDaily},
			5: {Name: "Gate 12 Position", Unit: "%", BaseValue: 75, MinValue: 0, MaxValue: 100, Pattern: PatternOperational},
			6: {Name: "Pump Station 1 Flow", Unit: "CFS", BaseValue: 500, MinValue: 300, MaxValue: 700, Pattern: PatternOperational},
			7: {Name: "North Branch Flow", Unit: "CFS", BaseValue: 400, MinValue: 200, MaxValue: 600, Pattern: PatternDaily},
			8: {Name: "Water Quality pH", Unit: "pH", BaseValue: 7.5, MinValue: 6.5, MaxValue: 8.5, Pattern: PatternConstant},
			9: {Name: "Pump Station 2 Status", Unit: "boolean", BaseValue: 1, MinValue: 0, MaxValue: 1, Pattern: PatternOperational},
			10: {Name: "Reservoir Inflow", Unit: "CFS", BaseValue: 1100, MinValue: 800, MaxValue: 1500, Pattern: PatternSeasonal},
			11: {Name: "System Efficiency", Unit: "%", BaseValue: 85, MinValue: 70, MaxValue: 95, Pattern: PatternOperational},
			12: {Name: "Turbidity Level", Unit: "NTU", BaseValue: 2.5, MinValue: 0.5, MaxValue: 5.0, Pattern: PatternConstant},
		},
	}
}
